...
storage_account_name = "adselblob"
storage_account_access_key = "cHw5LtqQiYP9r8qjgDUxdVgb+Rh+SEY62SuET+YNO/qyA6wkuIg1i+vVxlJi3YyxFrfa6/hQ+wWj6+zfs14mHQ=="

# COMMAND ----------

file_location = "wasbs://container@adselblob.blob.core.windows.net"
file_type = "csv"
...
# MAGIC %sql
# MAGIC 
# MAGIC SELECT * FROM YOUR_TEMP_VIEW_NAME 
